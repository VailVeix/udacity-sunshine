...
public class MainActivity extends AppCompatActivity {
    ...
    // Complete (35) Add a private com.example.android.sunshine.ForecastAdapter variable called mForecastAdapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Complete (41) set mForecastAdapter equal to a new com.example.android.sunshine.ForecastAdapter
        mForecaseAdapter = new ForecastAdapter();

        // Complete (42) Use mRecyclerView.setAdapter and pass in mForecastAdapter
        mRecyclerView.setAdapter(mForecaseAdapter);
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                ...
                for (String weatherString : weatherData) {
                    mForecaseAdapter.setmWeatherData(weatherData);
                }
            } else {
                showErrorMessage();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            mForecaseAdapter.setmWeatherData(null);
            loadWeatherData();
            return true;
        }
